...
from plaguebot_msgs.srv import EulerToQuaternion, QuaternionToEuler
...
class SimpleServiceServer(Node):
    def __init__(self):
        ...
        self.get_logger().info("Service Angle Conversion Services are READY!")
...
def main():
    rclpy.init()
    angles_converter = SimpleServiceServer()
